...
# A list is simply called list in python. A list is used to store collections of items, where each item in the list can be of any data type, and the items are
# ordered and mutable.
